export const conditions = [
  {
    ...
    propOne: [
      ...
      },
      {
        ...
        title: "Fatigued",
        propOne:
          "You're tired and can't summon much energy. You take a -1 status penalty to AC and saving throws. You can't use exploration activities performed while traveling, such as those listed here. You recover from fatigue after a full night's rest.",
      },
      {
        id: 15,
        title: "Flat-footed",
